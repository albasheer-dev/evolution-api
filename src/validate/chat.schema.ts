  ...
  properties: {
    where: {
      ...
      properties: {
        ...
        phonebookName: { type: 'string', minLength: 1 },
        whatsappPushName: { type: 'string', minLength: 1 },
        verifiedName: { type: 'string', minLength: 1 },
        username: { type: 'string', minLength: 1 },
        id: { type: 'string', minLength: 1 },
        remoteJid: { type: 'string', minLength: 1 },
        canonicalJid: { type: 'string', minLength: 1 },
        phoneNumberJid: { type: 'string', minLength: 1 },
        lidJid: { type: 'string', minLength: 1 },
